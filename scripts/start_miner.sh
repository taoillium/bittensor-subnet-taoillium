...
echo "Running miner"
python -m neurons.miner --netuid 2 --subtensor.chain_endpoint ws://127.0.0.1:9944 --subtensor.network local --wallet.name miner --wallet.hotkey default --logging.debug  --axon.port 8901 # --neuron.epoch_length 101